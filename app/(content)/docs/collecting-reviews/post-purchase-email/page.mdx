...
4. Customer submits the review on your hosted [Post Purchase Form](/docs/displaying-reviews/post-purchase-form).
...
- `{review_link}` - the unique link to the [Post Purchase Form](/docs/displaying-reviews/post-purchase-form) page - **must be present** for the email to work
